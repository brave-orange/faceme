...
def readPicSaveFace(sourcePath,objectPath,*suffix):
    try:
        ...
        count = 1
        face_cascade = cv2.CascadeClassifier('C:\\Users\\jan\\AppData\\Local\\Programs\\Python\\Python36\\Lib\\site-packages\\cv2\\data\\haarcascade_frontalface_alt.xml')
...
if __name__ == '__main__':
     readPicSaveFace('C:\\Users\\jan\\Desktop\\img','E:\\WWW\\faceRecognition\\img','.jpg','.JPG','png','png')
